...
export const SearchView: React.FC<SearchViewProps> = ({
  ...
  }, [searchQuery, selectedGenres, selectedStatus, selectedFormat, selectedSort, activeStudio]);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <div className="p-4 sm:p-5 rounded-3xl bg-[#121626] border border-slate-800/90 shadow-2xl space-y-4">
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-10 py-3.5 rounded-2xl bg-[#090b14] border border-slate-700/80 text-sm sm:text-base text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition shadow-inner"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-3.5 rounded-2xl text-xs sm:text-sm font-bold border transition shrink-0 ${
              showFiltersPanel
        ...
        {activeStudio && (
          <div className="flex items-center gap-2 flex-wrap pt-1">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-indigo-600 text-white text-xs font-bold shadow-md">
        ...
        {showFiltersPanel && (
          <div className="pt-4 border-t border-slate-800/90 space-y-5">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div className="flex items-center gap-2">
                  ...
                  {selectedGenres.length > 0 && (
                    <span className="px-2 py-0.5 rounded-md bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-[11px] font-bold">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${
                        isSelected
                          ...
                          : 'bg-[#090b14] border border-slate-800 text-slate-400 hover:text-slate-200 hover:border-slate-700'
                      }`}
                    >
            ...
            {/* Dropdown Selectors: Status, Format, Sort */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-[#090b14] border border-slate-700/80 text-xs font-semibold text-slate-200 focus:outline-none focus:border-indigo-500 cursor-pointer"
                >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
            <span>Results</span>
            <span className="text-xs font-semibold text-indigo-400 bg-indigo-950/60 border border-indigo-500/30 px-2 py-0.5 rounded-full">
        ...
        {isLoading && results.length === 0 ? (
          ...
          <div className="p-12 text-center rounded-3xl bg-[#121626] border border-slate-800/80 space-y-3">
